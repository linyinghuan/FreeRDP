...
typedef VOID(*AUDITOR_EVENT_CB)(proxyData* pdata, proxyChannelDataEventInfo* pEvent);

BOOL auditor_server_channels_init(proxyData* pdata);
BOOL auditor_client_channel_handler(proxyData* data, void* context, AUDITOR_CTX_DATA *auditor_ctx);
BOOL auditor_server_channel_handler(proxyData* data, void* context, AUDITOR_CTX_DATA *auditor_ctx);
